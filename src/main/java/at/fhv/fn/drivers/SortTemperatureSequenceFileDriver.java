...
import at.fhv.fn.sortedtemperature.TemperatureSequenceFileMapper;
 ...
 */
public class SortTemperatureSequenceFileDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        // Create a new Job
        Job job = Job.getInstance(conf, "SortTemperatureSequenceFile");
        ...
        job.setMapperClass(TemperatureSequenceFileMapper.class);
    ...
    public static void main(String args[]) throws Exception {
        int exitCode = ToolRunner.run(new SortTemperatureSequenceFileDriver(), args);
