...
import at.fhv.fn.meantemperature.NaiveMeanTemperatureReducer;
import at.fhv.fn.meantemperature.TemperatureRecordCounterMapper;
 ...
 */
public class NaiveMeanTemperatureDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        // Create a new Job
        Job job = Job.getInstance(conf, "NaiveMeanTemperature");
        ...
        job.setMapperClass(TemperatureRecordCounterMapper.class);
        job.setReducerClass(NaiveMeanTemperatureReducer.class);
    ...
    public static void main(String args[]) throws Exception {
        int exitCode = ToolRunner.run(new NaiveMeanTemperatureDriver(), args);
