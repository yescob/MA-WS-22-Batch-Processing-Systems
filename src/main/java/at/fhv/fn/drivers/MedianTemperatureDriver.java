...
import at.fhv.fn.mediantemperature.SortedTemperatureMapper;
import at.fhv.fn.mediantemperature.SortedTemperatureReducer;
import at.fhv.fn.mediantemperature.YearTemperatureGroupingComparator;
import at.fhv.fn.mediantemperature.YearTemperaturePartitioner;
import at.fhv.fn.mediantemperature.YearTemperatureRecord;
...
public class MedianTemperatureDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(SortedTemperatureMapper.class);
        job.setReducerClass(SortedTemperatureReducer.class);

        job.setPartitionerClass(YearTemperaturePartitioner.class);
        job.setGroupingComparatorClass(YearTemperatureGroupingComparator.class);

        job.setMapOutputKeyClass(YearTemperatureRecord.class);
