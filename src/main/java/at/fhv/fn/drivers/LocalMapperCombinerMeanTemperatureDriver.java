 ...
 */
public class LocalMapperCombinerMeanTemperatureDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        // Create a new Job
        Job job = Job.getInstance(conf, "LocalMapperCombinerMeanTemperature");
        ...
        job.setMapperClass(LocalCombinerMeanTemperatureMapper.class);

        job.setReducerClass(LocalCombinerMeanTemperatureReducer.class);
        ...
        // Different Output from reducer class
        job.setMapOutputValueClass(LocalSum.class);

        return job.waitForCompletion(true) ? 0 : 1;
    }

    public static void main(String args[]) throws Exception {
        int exitCode = ToolRunner.run(new LocalMapperCombinerMeanTemperatureDriver(), args);
